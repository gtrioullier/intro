...
def sum_points(todo1, todo2):
    ...
    5
    """
    sum = int(todo1['points']) + int(todo2['points'])
    return sum

todo = {'name': 'Example 1', 'body': 'This is a test task', 'points': '3'}
print_todo(todo)

todos = [{'name': 'Example 1', 'body': 'This is a test task', 'points': '3'}, {'name': 'Task 2', 'body': 'Yet another example task', 'points': '2'}]
todo, todos = take_first(todos)
